...
local function update(self)
    if not self.scar.enabled or (not self.scar.show and self.scar.condition ~= data.condition_state.Highlight) then
    ...
    elseif self.scar.condition == data.condition_state.Highlight then
